 ...
 * @param reactor
 */
pro[_watchStart] = function (data, reactor) {
    var the = this;

    if (typeis.Array(data)) {
        the[_onWatch](data, reactor);
        the[_onWatchArr](data, reactor);
 ...
 * @param reactor
 */
pro[_onWatch] = function (data, reactor) {
    var the = this;
 ...
 * @param reactor
 */
pro[_addReactor] = function (obj, reactor) {
    if (!obj[REACTOR_KEY]) {
        odf(obj, REACTOR_KEY, {
            value: reactor
        });
    ...
    if (!hasWatched[obj]) {
        ...
        odf(obj, key, {
            ...
            set: function (newVal) {
                ...
                the[_watchStart](newVal, reactor);
            }
        });
    }

    the[_watchStart](val, reactor);
};
 ...
 * @param reactor
 */
pro[_onWatchArr] = function (arr, reactor) {
    var the = this;
        ...
        array.each(OVERRIDE_ARRAY_METHODS, function (index, method) {
            ...
            odf(arr, method, {
                value: function () {
                    ...
                    the[_broadcast](arr, MOUNT_ARRAY_KEY, [newVal, oldVal, operation]);
                    the[_watchStart](newVal, reactor);
                }
            });
        });
...
function isObjectOrArray(any) {
    return typeis.Array(any) || typeis.Object(any);
}
